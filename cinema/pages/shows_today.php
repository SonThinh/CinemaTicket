  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="box">
        ...
        <div class="box-body">
          <?php
          $sw=mysqli_query($con,"SELECT * FROM shows WHERE st_id IN(SELECT st_id FROM show_time WHERE screen_id IN(SELECT screen_id FROM  screens WHERE cinema_id='".$_SESSION['cinema']."')) and status='1' and r_status='1'");
